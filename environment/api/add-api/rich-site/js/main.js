...
// Flickr API key
const apiKey = '4ed967ca8ae8aea18d3668c99fe3b18a';
...
const dogcat = function (url) {
  ...
  $.getJSON(url, (data) => {
    ...
    // 空の<div>を作る'<div>'というタグをJQueryで作成ということですが、これにより、空の<div></div>が、$div に格納されている
    const $div = $('<div>');
   ...
   $div.appendTo('.image-gallery__cat');
  $div.appendTo('.image-gallery__dog');
...
console.log(url2);
const dogresult = dogcat(url2);




// $divをそれぞれ犬と猫のクラスに追加する


// imagekansu(url1).appendTo('.image-gallery__cat');
// imagekansu(url2).appendTo('.image-gallery__dog');
